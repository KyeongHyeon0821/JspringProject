  ...
  <br/>
    <div class="text-center" style="height:500px;">
        ...
        <c:forEach var="prevDay" begin="${prevLastDay - (startWeek -2)}" end="${prevLastDay}">
          <td style="font-size:0.6em; color:#ccc; vertical-align:middle;">
        ...
        <c:forEach begin="1" end="${lastDay}" varStatus="st">
        	...
        	<td id="td${cnt}" ${todaySw == 1 ? 'class=today' : ''} style="vertical-align:middle;">
        	  ${st.count}
        	</td>
        ...
        <c:forEach var="nextDay" begin="${nextStartWeek}" end="7" varStatus="st">
        	<c:if test="${nextStartWeek != 1}">
          	<td style="font-size:0.6em; color:#ccc; vertical-align:middle;">${nextYear} - ${nextMonth+1} - ${st.count}</td>
          </c:if>
        </c:forEach>
      </tr>
    </table>
