...
<div class="container">
  ...
  <div class="mb-2">
	...
	<div>
		...
		<button type="button" onclick="modalCheck2('${name}','${age}','${address}')" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#myModal7">Open modal 7</button>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <c:forEach items="${vos}" var="vo">
	        	<hr/>
		        <p class="mid">아이디 : ${vo.mid}</p>
		        <p class="name">이름 : ${vo.name}</p>
		        <p class="nickName">닉네임 : ${vo.nickName}</p>
		        <p class="birthday">생일 : ${vo.birthday}</p>
		        <p class="job">직업 : ${vo.job}</p>
		        <hr/>
	        </c:forEach>
	      </div>
	      <div class="modal-footer">
