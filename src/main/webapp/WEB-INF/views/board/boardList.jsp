  	...
  	<tr>
  		...
  		<td class="text-end">
  			<select name="pageSize" id="pageSize" onchange="pageSizeCheck()">
  				<option ${pageSize==5 ? 'selected' : '5'}>5</option>
  				<option ${pageSize==10 ? 'selected' : '10'}>10</option>
  				<option ${pageSize==15 ? 'selected' : '15'}>15</option>
  				<option ${pageSize==20 ? 'selected' : '20'}>20</option>
  				<option ${pageSize==30 ? 'selected' : '30'}>30</option>
  				<option ${pageSize==50 ? 'selected' : '50'}>50</option>
  ...
  <table class="table table-hover text-center">
  	...
  	<c:forEach var="vo" items="${vos}" varStatus="st">
	  	<tr>
	  		<td>${curScrStartNo}</td>
	  		<td class="text-start">
	  			<a href="boardContent?pag=${pag}&pageSize=${pageSize}&idx=${vo.idx}">${vo.title}</a>
